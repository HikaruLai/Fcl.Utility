...
namespace Fcl.Utility
{
    ...
    {
        public static readonly String dateTime = "yyyyMMddHHmmssfff";
        public static readonly String dateTimeShort = "yyyyMMddHHmmss";
        public static readonly String date = "yyyyMMdd";
        private static readonly CultureInfo cl = CultureInfo.InvariantCulture;
        private static readonly DateTime unixStart = new DateTime(1970, 1, 1, 0, 0, 0); //DateTimeKind.Local );
        private static readonly String centuryHead = "20";
        ...
        public DateUtility(string patternDateTime = null)
        {
            ...
            this.PatternDateTime = patternDateTime ?? dateTimeShort;
        }

        public string GetStrByDateTime(DateTime dt)
        {
            return dt.ToString(this.PatternDateTime, cl);
        }
        ...
        {
            return d.ToString(this.PatternDate, cl);
        }
        ...
        public bool TryGetDateByStr(string strDate, out DateTime d)
        {
            return DateTime.TryParseExact(
                strDate, this.PatternDate, cl, DateTimeStyles.None, out d
            );
        }
        ...
        {
            return DateTime.TryParseExact(
                strDateTime, this.PatternDateTime, cl, DateTimeStyles.None, out dt
            );
        }
        ...
        {
            this.PatternDate = DateUtility.date;
            this.PatternDateTime = DateUtility.dateTime;
        }
        ...
        public string GetStrByUnixTime(byte[] unixTime, string endian = "LE")
        {
            ...
            return this.GetStrByDateTime(unixStart.AddSeconds(seconds));
        }
        ...
        public byte[] GetUnixTimeByStr(string strDateTime, string endian = "LE")
        {
            ...
            {
                uint seconds = (uint)(dt - unixStart).TotalSeconds;
        ...
        {
            string bom = centuryHead + yyMM + "01";   // first day of the month
            ...
            return centuryHead + yyMM + "31";  // the most date of the month
        }
    }
}
